     ...
     return (
       <div className="bg-white text-[#1a1a1a] font-sans selection:bg-[#c4a484] selection:text-white">
         ...
         <nav className="px-10 py-5 flex justify-between items-center sticky top-0 bg-white/95 backdrop-blur-md z-[100] border-b border-gray-100">
           <div className="text-2xl font-black tracking-tighter">JUBILEE</div>
         ...
         <footer className="bg-[#1a1a1a] text-white py-20 px-10 text-center">
           <h3 className="text-3xl font-bold tracking-[0.3em] mb-10">JUBILEE</h3>
           <p className="text-gray-500 text-[10px] uppercase tracking-[0.5em] mb-10">© 2026 JUBILEE STUDIO — BUILT BY NAWAZ</p>
            ...
            <section className="relative h-[90vh] bg-gray-200 overflow-hidden group">
              ...
              <div className="absolute bottom-20 left-10 text-white max-w-xl">
                ...
                <p className="text-[11px] uppercase tracking-[0.2em] mb-8 opacity-80 leading-loose">
                  Defined by signature apparel and accessories dedicated to our hometown team for the 2026 Playoffs.
                </p>
                <div className="flex gap-4">
                        ...
                        <div className="lg:col-span-7">
                            <div className="rounded-[3rem] overflow-hidden border border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.5)] bg-[#0a0a0a]">
                                <StorePreview project={project} />
                                                        ...
                                                        {/* Shopify Analytics Dashboard Section */}

                {/* {project.analytics && (
                <div className="mt-20 w-full">
                    <div className="p-10 bg-white rounded-[1.5rem] text-[#1a1a1a] shadow-sm border border-gray-100">

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        
                        <div className="flex flex-col bg-[#f4f4f4] rounded-xl p-6 relative">
                        ...
                        <div className="flex items-center gap-1.5 text-[13px] text-gray-800 mb-5">
                            <ChevronDown size={14} className="text-gray-400" strokeWidth={3}/> 
                            <span className="font-semibold border-b border-dotted border-gray-400 pb-0.5">Sessions</span>
                        </div>
                        
                        <div className="flex items-center gap-2.5">
                            <span className="text-3xl font-bold tracking-tight text-black">{project.analytics.sessions.value}</span>
                            <div className={`flex items-center gap-1 text-[13px] font-bold ${project.analytics.sessions.isUp ? 'text-green-700' : 'text-red-600'}`}>
                        ...
                        <div className="flex items-center gap-1.5 text-[13px] text-gray-800 mb-5">
                            <ChevronUp size={14} className="text-gray-400" strokeWidth={3}/> 
                            <span className="font-semibold border-b border-dotted border-gray-400 pb-0.5">Total sales</span>
                        </div>
                        <div className="flex items-center gap-2.5">
                            <span className="text-3xl font-bold tracking-tight text-black">{project.analytics.totalSales.value}</span>
                            <div className={`flex items-center gap-1 text-[13px] font-bold ${project.analytics.totalSales.isUp ? 'text-green-700' : 'text-red-600'}`}>
                            <ArrowUpRight size={14} strokeWidth={3}/>
                        ...
                        <div className="flex items-center gap-1.5 text-[13px] text-gray-800 mb-5">
                            <ChevronDown size={14} className="text-gray-400" strokeWidth={3}/> 
                            <span className="font-semibold border-b border-dotted border-gray-400 pb-0.5">Orders</span>
                        </div>
                        <div className="flex items-center gap-2.5">
                            <span className="text-3xl font-bold tracking-tight text-black">{project.analytics.totalOrders.value}</span>
                            <div className={`flex items-center gap-1 text-[13px] font-bold ${project.analytics.totalOrders.isUp ? 'text-green-700' : 'text-red-600'}`}>
                            <ArrowUpRight size={14} strokeWidth={3}/>
                        ...
                        <div className="flex items-center gap-1.5 text-[13px] text-gray-800 mb-5">
                            <ChevronUp size={14} className="text-gray-400" strokeWidth={3}/> 
                            <span className="font-semibold border-b border-dotted border-gray-400 pb-0.5">Conversion rate</span>
                        </div>
                        <div className="flex items-center gap-2.5">
                            <span className="text-3xl font-bold tracking-tight text-black">{project.analytics.conversionRate.value}</span>
                            <div className={`flex items-center gap-1 text-[13px] font-bold ${project.analytics.conversionRate.isUp ? 'text-green-700' : 'text-red-600'}`}>
                            <ArrowUpRight size={14} strokeWidth={3}/>
    ...
    <div className="mt-20 w-full font-sans antialiased">
        <div className="p-10 bg-white rounded-[1.5rem] text-[#1a1a1a] shadow-sm border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col bg-[#f4f4f4] rounded-xl p-6 relative border border-gray-200">
                    <div className="absolute top-5 right-5 text-gray-400">
                    ...
                    <div className="flex items-center text-[13px] font-bold text-[#303030] mb-5">
          
                        <span className="border-b border-dotted border-gray-400 pb-0.5 leading-none">Sessions</span>
                    </div>
                    
                    <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-[900] tracking-tighter text-black leading-none italic-none">
                            {project.analytics.sessions.value}
                        </span>
                        <div className={`flex items-center text-[12px] font-black ${project.analytics.sessions.isUp ? 'text-[#008060]' : 'text-red-600'} leading-none mb-0.5`}>
                            <ArrowUpRight size={13} strokeWidth={4} />
                            <span>{project.analytics.sessions.change}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col p-6">
                    ...
                    <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-[900] tracking-tighter text-black leading-none">
                            {project.analytics.totalSales.value}
                        </span>
                        <div className={`flex items-center text-[12px] font-black ${project.analytics.totalSales.isUp ? 'text-[#008060]' : 'text-red-600'} leading-none mb-0.5`}>
                            <ArrowUpRight size={13} strokeWidth={4} />
                            <span>{project.analytics.totalSales.change}</span>
                        </div>
                    </div>
                ...
                <div className="flex flex-col p-6">
                    ...
                    <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-[900] tracking-tighter text-black leading-none">
                            {project.analytics.totalOrders.value}
                        </span>
                        <div className={`flex items-center text-[12px] font-black ${project.analytics.totalOrders.isUp ? 'text-[#008060]' : 'text-red-600'} leading-none mb-0.5`}>
                            <ArrowUpRight size={13} strokeWidth={4} />
                            <span>{project.analytics.totalOrders.change}</span>
                        </div>
                    </div>
                ...
                <div className="flex flex-col p-6 relative">
                    ...
                    <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-[900] tracking-tighter text-black leading-none">
                            {project.analytics.conversionRate.value}
                        </span>
                        <div className={`flex items-center text-[12px] font-black ${project.analytics.conversionRate.isUp ? 'text-[#008060]' : 'text-red-600'} leading-none mb-0.5`}>
                            <ArrowUpRight size={13} strokeWidth={4} />
                            <span>{project.analytics.conversionRate.change}</span>
                        </div>
                    </div>
