      ...
      >
        ...
        <section className="border-l-2 border-primary/30 pl-8">
          ...
          <p className="text-white/60 leading-relaxed">
            I specialize in building professional online stores. When you hire <span className="text-white">Nawaz Builds</span>, I work hard to give you a premium design. Our goal is to make sure your Shopify development project is a success.
          </p>
        </section>
        ...
        <section className="bg-white/5 border border-white/10 p-8 rounded-[2rem]">
          ...
          <ul className="space-y-4">
            {[
              ...
              "Reply to our messages so I can finish the work on time."
            ].map((item, index) => (
        ...
        <section>
          ...
          <p className="text-white/60 leading-relaxed">
            I start working once I agree on the price and plan. All payments for our Shopify services should be made through our <span className="text-white font-medium">official channels</span>. This keeps everything safe and clear for both of us.
          </p>
        </section>
        ...
        <section className="bg-primary/5 border border-primary/10 p-8 rounded-[2rem]">
          ...
          <p className="text-white/60 leading-relaxed">
            The design and code I create for you become your property <span className="text-white underline underline-offset-4 decoration-primary/40">after full payment</span>. However, the name Nawaz Builds and the content on this website belong to us. Please do not copy our work without asking.
          </p>
        </section>
        ...
        <section className="relative overflow-hidden p-8 border border-white/5 bg-white/[0.02] rounded-[2rem]">
          ...
          <p className="text-white/60 relative z-10 leading-relaxed">
            At Nawaz Builds, I value honesty. I promise to use our expertise to build the best store for you. You can see our past work on our {" "}
            <Link to="/#portfolio" className="text-primary hover:underline font-bold">
              [Portfolio]
            </Link>{" "}
            page to see our high standards.
          </p>
        </section>
